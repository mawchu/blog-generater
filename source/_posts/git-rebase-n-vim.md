...
<img style='margin-right: unset; margin-left: unset; padding-top: 30px' src='https://needone.app/content/images/size/w2000/2022/09/git-rebase-vs-git-merge.png' width='min(100%, 600px)' height='auto'>
...
以上步驟執行完就可以看到commit tree 的改變並推送成功！