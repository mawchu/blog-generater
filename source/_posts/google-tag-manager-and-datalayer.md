...
<img class="post-image" style='margin-right: unset; margin-left: unset; padding-top: 12px' src='/blog/images/google-tag-manager-and-datalayer-0.jpg' alt="https://www.maxlist.xyz/2023/06/01/gtm-datalayer/" width='min(100%, 600px)' height='auto'>
...
```js
apiCheck({ answers: Object.values(this.answers) }).then((resp) => {
  if (resp.data) {
